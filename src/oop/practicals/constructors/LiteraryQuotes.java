...
public class LiteraryQuotes {

    public void shakespeareQuote() {
        System.out.println("Good night, good night! Parting is such sweet sorrow, that I shall say good night " +
                "till it be morrow. Shakespeare");
    }
    ...
    public void churchillQuote() {
        System.out.println("Continuous effort - not strength or intelligence - is the key to unlocking our potential. " +
                "Churchill");
    }
    ...
    public void albertEinsteinQuote(){
